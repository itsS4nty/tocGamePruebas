...
//				console.log("<- "+a+" : "+numFuncInit);
	...
	function loadDataS(sat, callbackInit) {
		...
		(function (callbackInit) {	
			...
			H.Articles.createSat(sat, newCallbackInit());
			H.Teclats.createSat(sat, newCallbackInit());
			H.Dependentes.createSat(sat, newCallbackInit());
			H.ConceptosEntrega.createSat(sat, true, newCallbackInit());
			H.Caja.createSat(sat, true, newCallbackInit());

			CallbackInitActivate();

		})(newCallbackInit());
		
		H.Comandes.createSat(sat, newCallbackInit()); // Comandes necesita que caja este inicializado
