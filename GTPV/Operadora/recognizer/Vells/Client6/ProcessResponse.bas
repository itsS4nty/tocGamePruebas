...
Public Function ProcessResponse(Request As DOMDocument30, Response As DOMDocument30, _
    ...
    Dim node As IXMLDOMNode
    Dim CalDir As String
    
    If Not NoEsPrimerCop Then Digues "Cargando Sintaxi."
    CalDir = ""
    ...
    If Len(CalDir) > 0 Then Digues CalDir
    
    
    If Not NoEsPrimerCop Then Digues "Hola ?, hay alguien? Di Hola."
    NoEsPrimerCop = True
