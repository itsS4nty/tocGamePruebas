...
function tablaVentas ( byval D )
    if Session("Usuari_NivellSeguretat") = 5 then
		tablaVentas = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Venut_Previsio_" & year(D) & "-" & right("00" & month(D),2) & "]"
    else
		tablaVentas = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Venut_" & year(D) & "-" & right("00" & month(D),2) & "]"
	end if
	if not exists (tablaVentas) then
		sqlCTV = "CREATE TABLE " & tablaVentas & " ([Botiga] [float] NULL ,[Data] [datetime] NULL ,"
...
function tablaAnulats ( byval D )
	tablaAnulats = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Anulats_" & year(D) & "-" & right("00" & month(D),2) & "]"
	if not exists (tablaAnulats) then
		sqlCTA = "CREATE TABLE " & tablaAnulats & " ([Botiga] [float] NULL ,[Data] [datetime] NULL ,[Dependenta] [float] NULL ,"
...
function tablaAlertes ( byval D )
	tablaAlertes = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Alertes_" & year(D) & "-" & right("00" & month(D),2) & "]"
	if not exists (tablaAlertes) then
		sqlCTA = "CREATE TABLE " & tablaAlertes & " ([Id] [uniqueidentifier] NULL CONSTRAINT "
...
function tablaHoraris ( byval D )
	tablaHoraris = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Horaris_" & year(D) & "-" & right("00" & month(D),2) & "]"
...
function tablaMoviments ( byval D )
   tablaMoviments = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Moviments_" & year(D) & "-" & right("00" & month(D),2) & "]"
...
function tablaMovimentsEstat ( byval D )
   tablaMovimentsEstat = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Moviments_" & year(D) & "-" & right("00" & month(D),2) & "_Estat]"
...
function tablaAlbarans (byval D)
	tablaAlbarans = "[" & session("Usuari_Empresa_Db") & "].dbo.[v_albarans_" & year(D) & "-" & right("00" & month(D),2) & "]"
...
function tablaRevisats ( byval D )
	tablaRevisats = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Revisat_" & year(D) & "-" & right("00" & month(D),2) & "]"
...
function tablaServits(byval D)
	...
	tablaServits = "[" & session("Usuari_Empresa_Db") & "].dbo.[" & NomTaula & "]"	
	...
	if not exists (tablaServits) then
		...
		Sql = "CREATE TABLE [" & session("Usuari_Empresa_Db") & "].dbo.[" & NomTaula & "Trace] ("
		...
		Sql = "CREATE TRIGGER [M_" & Nomtaula & "] ON [" & session("Usuari_Empresa_Db") & "].dbo.[" &  Nomtaula & "] "
		Sql = Sql & "AFTER INSERT,UPDATE,DELETE AS "
		Sql = Sql & "Update [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "] Set [TimeStamp] = GetDate(),    [QuiStamp]  = Host_Name() Where Id In (Select Id From Inserted) "
		Sql = Sql & "Insert Into [" & session("Usuari_Empresa_Db") & "].dbo.ComandesModificades Select Id As Id,GetDate() As [TimeStamp],'" & Nomtaula & "' As TaulaOrigen From Inserted "
		Sql = Sql & "Insert into [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "Trace] (Id,[TimeStamp],[QuiStamp],Client,CodiArticle,PluUtilitzat,Viatge,Equip,QuantitatDemanada,QuantitatTornada,QuantitatServida,MotiuModificacio,Hora,TipusComanda,Comentari,ComentariPer,Atribut,CitaDemanada) Select Id,[TimeStamp],[QuiStamp],Client,CodiArticle,PluUtilitzat,Viatge,Equip,QuantitatDemanada,QuantitatTornada,QuantitatServida,MotiuModificacio,Hora,TipusComanda,Comentari,ComentariPer,Atribut,CitaDemanada  from [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "] Where Id In (Select Id From Inserted)"
		...
		Sql = Sql & "If Update (QuantitatTornada)  Update [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "] Set [CitaTornada]  = Cast(CAST(Host_Name() AS VarChar(255)) + ',' + CAST(QuantitatTornada  AS VarChar(255))  + ',' + CAST(GetDate() AS VarChar(255))  +  '/' + [CitaTornada]  AS VarChar(255)) Where Id In (Select Id From Inserted) "
		Sql = Sql & "If Update (QuantitatServida)  Update [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "] Set [CitaServida]  = Cast(CAST(Host_Name() AS VarChar(255)) + ',' + CAST(QuantitatServida  AS VarChar(255))  + ',' + CAST(GetDate() AS VarChar(255))  +  '/' + [CitaServida]  AS VarChar(255)) Where Id In (Select Id From Inserted) "
		Sql = Sql & "If Update (QuantitatDemanada) Update [" & session("Usuari_Empresa_Db") & "].dbo.[" & Nomtaula & "] Set [CitaDemanada] = Cast(CAST(Host_Name() AS VarChar(255)) + ',' + CAST(QuantitatDemanada AS VarChar(255))  + ',' + CAST(GetDate() AS VarChar(255))  +  '/' + [CitaDemanada] AS VarChar(255)) Where Id In (Select Id From Inserted) "
		
		rec  Sql
	end if

	if not exists ("[" & session("Usuari_Empresa_Db") & "].dbo.[" & NomTaula & "Trace]") then
		Sql = "CREATE TABLE [" & session("Usuari_Empresa_Db") & "].dbo.[" & NomTaula & "Trace] ("
		Sql = Sql & "[Modificat]         [datetime]              Default (GetDate())  ,"
		Sql = Sql & "[Id]                [nvarchar] (255) Null ,"
		Sql = Sql & "[TimeStamp]         [datetime]       Null ,"
		...
		Sql = "DROP TRIGGER [" & session("Usuari_Empresa_Db") & "].dbo.[M_" & Nomtaula & "] "
		rec  Sql
   
		Sql = "CREATE TRIGGER [" & session("Usuari_Empresa_Db") & "].dbo.[M_" & Nomtaula & "] ON [" & Nomtaula & "] "
		Sql = Sql & "AFTER INSERT,UPDATE,DELETE AS "
...
function taulaTornats ( byval D )
   taulaTornats = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Tornat_" & year(D) & "-" & right("00" & month(D),2) & "]"
end function


function tablaLogs ( byval D )
	tablaLogs = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Log_" & year(D) & "-" & right("00" & month(D),2) & "]"
end function
...
function tablaInventaris ( byval D )
	tablaInventaris = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Inventaris_" & year(D) & "-" & right("00" & month(D),2) & "]"
	if not exists(tablaInventaris) then
		sqlCTI = "CREATE TABLE " & tablaInventaris & " ([Botiga] [float] NULL ,[Data] [datetime] NULL ,[Dependenta] [float] NULL ,"
...
function tablaFacturacioIva ( byval D )
	tablaFacturacioIva = "[" & session("Usuari_Empresa_Db") & "].dbo.[facturacio_" & year(D) & "-" & right("0" & month(D),2) & "_iva]"
...
function tablaFacturacioData ( byval D )
	tablaFacturacioData = "[" & session("Usuari_Empresa_Db") & "].dbo.[facturacio_" & year(D) & "-" & right("0" & month(D),2) & "_Data]"
...
function tablaPressupostData ( byval D )
	tablaPressupostData = "[" & session("Usuari_Empresa_Db") & "].dbo.[pressupost_" & year(D) & "-" & right("0" & month(D),2) & "_Data]"
...
function tablaPressupostIva ( byval D )
	tablaPressupostIva = "[" & session("Usuari_Empresa_Db") & "].dbo.[pressupost_" & year(D) & "-" & right("0" & month(D),2) & "_iva]"
...
function tablaFacturacioReb ( byval D )
	tablaFacturacioReb = "[" & session("Usuari_Empresa_Db") & "].dbo.[facturacio_" & year(D) & "-" & right("0" & month(D),2) & "_reb]"
...
function tablaPressupostReb ( byval D )
	tablaPressupostReb = "[" & session("Usuari_Empresa_Db") & "].dbo.[pressupost_" & year(D) & "-" & right("0" & month(D),2) & "_reb]"
...
function tablaEstadisticas ( byval D )
	tablaEstadisticas = "[" & session("Usuari_Empresa_Db") & "].dbo.[V_Estadis_" & year(D) & "-" & right("00" & month(D),2) & "]"
...
function tablaEncarrecs ( byval D )
	tablaEncarrecs = "[" & session("Usuari_Empresa_Db") & "].dbo.[v_encarre_" & year(D) & "-" & right("0" & month(D),2) & "]"
