...
procesoEntradaSalidaDependenta = function() {	
	...
	$("<button>").text("Entrar").css({width:"25%",height:"25%"}).click(entrarHandler).appendTo(divCont0);
	var butPlegar = $("<button>").text("Plegar").css({width:"25%",height:"25%"}).click(plegarHandler).appendTo(divCont0);
...
procesoInicializarConServidor = function() {
	...
	my.init = function() {
		...
		div1.appendTo(layoutPrincipal.content).hide();
