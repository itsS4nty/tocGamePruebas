...
$stat = "delete from [scoge_teclatstpv]";
$sql = odbc_prepare($ConnDB, $stat);	
odbc_execute($sql, array()); 

$stat = "insert into [scoge_teclatstpv] ( Data, Llicencia, Maquina, Dependenta, Ambient	, Article, Pos, Color) values 
			                            (?, ?, ?, ?, ?, ?, ?, ?)";
...
$stat = "select * from [scoge_teclatstpv]";
$sql = odbc_prepare($ConnDB, $stat);	
odbc_execute($sql, array()); 
odbc_result_all($sql);
