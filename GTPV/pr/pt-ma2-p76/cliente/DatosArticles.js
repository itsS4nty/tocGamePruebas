...
//			callbackChangeHandlers();
	...
	my.createSat = function(sat, callback) {
		var obj = sat.createObj("Articles", createObjSat, createObjHost, callback, availableCommHandler);
		sats.push(sat);
		objs.push(obj);
...
H.Scripts.addLocalExec("DatosArticlesS", function(window) {
...
H.Scripts.addLocalExec("CodisBarresS", function(window) {
