H.Scripts.addLocalExec("editorTeclatsS", function() {
...
window.AppEditorTeclats = function() {
	...
	var divEditor = $("<div>")._100x100().addClass("ui-widget-content").appendTo(div0); 
...
//		hTeclado : 0.6,
	...
	var selColorDiv = $("<div>")._100x100().css({ padding: SEP }).addClass("ui-widget-content").appendTo(divT); 
	...
	var butAddGrup = $("<button>").text(M("Nou Grup")).data("data", "addGrup");
	var butModGrup = $("<button>").text(M("Renombrar Grup")).data("data", "renGrup");
	var butDelGrup = $("<button>").text(M("Borrar Grup")).data("data", "delGrup");
	var butDelArticle = $("<button>").text(M("Borrar Article")).data("data", "delArticle");
