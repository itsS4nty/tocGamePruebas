H.Scripts.addLocalExec("ScrollS", function() {
...
*/		var dim = ((type == "u") || (type == "d")) ? "height" : "width"
		return ($("<image src='cliente/css/gtpv/img/arrow"+type.toUpperCase()+".GIF'/>"))[dim]("100%");
	}
	...
	function resize() {
		...
		if (pm.sizeGroupArrow != null) { 
			...
			$("<div>").css({ display: "inline-block" }).html("XX<br>XX").addClass("ui-state-default").appendTo(butT);
