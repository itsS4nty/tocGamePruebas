...
*/	}
	...
	function redraw() {
		...
		for (var i=0, pos=null; i < menus[S.menu].length; i++) {
			...
			var el = menuModel.clone(true).data("data", op).text(M(opMenu[op].text)).appendTo(menuScroll.newElement());	
...
function debug(str) { $("<div>").append(str).appendTo("body"); }
