...
//		hTeclado : 0.6,
	...
	my.redraw = function(_datos) {
		setButtonBuscarArticleEntrarArticle();		
		D = (_datos || {});
...
//		resizeDivTBE();
	...
	var buttonBuscarArticle = $("<button>").click(clickBuscarArticleHandler);
...
//		resizeDivTBE();
	...
	var buttonEntrarArticle = $("<button>").appendTo(divBuscar).click(clickEntrarArticleHandler);

	function setButtonBuscarArticleEntrarArticle() {
		buttonBuscarArticle.text(M("Buscar Article"));
