...
*/
WW.createDiv = function() { return $("<div>").css({boxSizing: "border-box", overflow: "hidden"}); }
WW.createDivAbs = function() { return createDiv().css({position: "absolute"}); }
WW.createDivRel = function() { return createDiv().css({position: "relative"}); }
