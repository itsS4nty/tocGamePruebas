...
// params: dir
window.scrollT = function(div, touchH, control, _params) {
	var my = {};
	...
	function calcSizes() {
		var sizeScroll = div[(params.dir == 'x')?'oWidth':'oHeight']();
		realSizeCont = div.parent()[(params.dir == 'x')?'iWidth':'iHeight']();
		sizeCont = (realSizeCont > sizeScroll) ? sizeScroll: realSizeCont;
...
*/			var curP = denormalizeP(getLotPos());
	...
	my.scrollToVisible = function(p0,p1) {
		calcSizes();
		var pos = -getLotPos();
		if (p0<pos) pos = p0;
