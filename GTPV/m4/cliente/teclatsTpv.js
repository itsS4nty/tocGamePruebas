H.Scripts.add("teclatsTpvS", "L2", function(window) {
...
//		resizeDivTBE();
	...
	var nivellModel = $("<button>").addClass("g-state-default");
	...
	var autoCompleteEntrarModel = $("<button>").addClass("g-state-default");
