H.Scripts.addLocalExec("alertDialogS", "LTC", function() {

window.newAlertDialog = function () {
	var my = {};
	
	var div = $("<div style='position: absolute; width: 100%; height: 100%'>\
	                <div class='ui-widget-overlay' style='z-index: 1000'></div>\
                    <div class='g-widget-content ui-corner-all' style='position: absolute; z-index: 1001; width: 30%'>\
                       <div class='g-widget-header ui-corner-all' style='margin: .5em 1em; padding: .5em 1em'></div>\
                       <div class='g-widget-content' style='margin: .5em 1em; padding: .5em 1em'>\
                          <span class='ui-icon ui-icon-alert' style='float:left; margin-right:1em'></span>\
                          <span></span>\
                       </div>\
                       <div class='g-widget-content' style='margin: .5em 1em'></div>\
	...
	my.appendTo = function(target) { div.appendTo(target); return my; }
	...
	my.setButtons = function(butArray, handler) {
		...
		for (var i=0; i<butArray.length; i++) {
			$("<button>").text(butArray[i])
			             .css({margin: ".5em 1em", padding: ".5em 1em"}).addClass("g-state-default ui-corner-all")
