H.Scripts.addLocalExec("langManagerS", function(window) {
...
window.AppLangManager = function() {
	...
	var divM = $("<div>")._100x100().addClass("ui-widget-content").appendTo(div0);
	...
	var langsModel = $("<button>").addClass("ui-state-default");
	...
	var divButtons = $("<div>").css({ position: "absolute", right : "0px", bottom : "0px", padding: SEP, width: "30%"})
	                           .appendTo(divM);
	var butSel = $("<button>").css({width: "100%"}).appendTo(divButtons)
							  .click( function (e) {
										if (e.button !== 0) return;
